    ...
    <SmartLink href='/' passHref legacyBehavior>
      <div className='flex flex-nowrap items-center cursor-pointer font-extrabold'>
        ...
        <div id='logo-text' className='group rounded-2xl flex-none relative'>
          ...
          <div className='flex justify-center rounded-2xl group-hover:bg-[#31433f] dark:group-hover:bg-[#d4af5e] w-full group-hover:opacity-100 opacity-0 invisible group-hover:visible absolute top-0 py-1 duration-200'>
