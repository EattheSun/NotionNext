...
function DarkModeBlockButton() {
  ...
  return (
    <button
      ...
      className={
        'group duration-200 hover:text-white hover:shadow-md hover:bg-[#31433f] flex justify-between items-center px-2 py-2 border dark:border-gray-600 bg-white dark:bg-[#d4af5e]  rounded-lg'
      }>
...
function Button({ title, url }) {
  return (
    <SmartLink
      href={url}
      className={
        'duration-200 hover:text-white hover:shadow-md flex cursor-pointer justify-between items-center px-2 py-2 border dark:border-gray-600 bg-white hover:bg-[#31433f] dark:bg-[#1e1e1e] rounded-lg'
      }>
      {title}
    </SmartLink>
  )
