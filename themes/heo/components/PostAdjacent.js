  ...
  return (
    <div id='article-end'>
      ...
      <div
        ...
        <SmartLink
          href={`/${next.slug}`}
          className='text-sm block p-4 w-72 h-28 cursor-pointer drop-shadow-xl duration transition-all dark:bg-[#1e1e1e] border dark:border-gray-600 bg-white dark:text-gray-300 dark:hover:text-[#eadfbd] hover:font-bold hover:text-[#31433f] rounded-lg'>
