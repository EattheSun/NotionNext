              ...
              return (
                    ...
                    >
                        <div className={`${className || ''} 
                            ${selected ? 'text-white bg-[#31433f] dark:bg-[#d4af5e]' : ''}
                            flex items-center hover:bg-[#31433f] dark:hover:bg-[#d4af5e] hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all`}
                        >
