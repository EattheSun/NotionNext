    ...
    <article
      ...
      <div
        ...
        className={
          ...
          ' wow fadeInUp border bg-white dark:bg-[#1e1e1e] flex mb-4 flex-col h-[23rem] md:h-52 md:flex-row  group w-full dark:border-gray-600 hover:border-[#31433f]  dark:hover:border-[#eadfbd] duration-300 transition-colors justify-between overflow-hidden rounded-xl'
        }>
        {/* 图片封面 */}
        {showPageCover && (
        ...
        <div
          ...
          <header>
            ...
            {post?.category && (
              <div
                className={`flex mb-1 items-center ${showPreview ? 'justify-center' : 'justify-start'} hidden md:block flex-wrap dark:text-gray-300 text-gray-600 hover:text-[#31433f] dark:hover:text-[#eadfbd]`}>
                <SmartLink
                  passHref
            ...
            <SmartLink
              ...
              passHref
              className={
                ' group-hover:text-[#31433f] dark:hover:text-[#eadfbd] dark:group-hover:text-[#eadfbd] text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'
              }>
