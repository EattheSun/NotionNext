  ...
  return (
    <div
      ...
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1e1e1e]  
            ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-[#31433f] dark:hover:border-[#d4af5e] ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
      <div
      ...
      <div id='category-bar-next' className='flex items-center justify-center'>
        <div
          id='right'
          className='cursor-pointer mx-2 dark:text-gray-300 dark:hover:text-[#eadfbd] hover:text-[#31433f]'
        ...
        <SmartLink
          href='/category'
          className='whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-[#31433f] dark:hover:text-[#eadfbd]'>
...
const MenuItem = ({ href, name }) => {
  ...
  return (
    <div
      className={`yuezhao-category-item whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-[#31433f] dark:hover:text-[#eadfbd] ${selected ? 'is-selected text-[#171a18] dark:text-[#eadfbd]' : ''}`}>
