...
export default function CustomContextMenu(props) {
  ...
  return (
    <div
      ...
      {/* 菜单内容 */}
      <div className='rounded-xl w-52 dark:hover:border-[#d4af5e] bg-white dark:bg-[#040404] dark:text-gray-200 dark:border-gray-600 p-3 border drop-shadow-lg flex-col duration-300 transition-colors'>
        {/* 顶部导航按钮 */}
        <div className='flex justify-between'>
          <i
            onClick={handleBack}
            className='hover:bg-[#31433f] hover:text-white px-2 py-2 text-center w-8 rounded cursor-pointer fa-solid fa-arrow-left'></i>
          <i
            onClick={handleForward}
            className='hover:bg-[#31433f] hover:text-white px-2 py-2 text-center w-8 rounded cursor-pointer fa-solid fa-arrow-right'></i>
          <i
            onClick={handleRefresh}
            className='hover:bg-[#31433f] hover:text-white px-2 py-2 text-center w-8 rounded cursor-pointer fa-solid fa-rotate-right'></i>
          <i
            onClick={handleScrollTop}
            className='hover:bg-[#31433f] hover:text-white px-2 py-2 text-center w-8 rounded cursor-pointer fa-solid fa-arrow-up'></i>
        </div>
        ...
        <div className='w-full px-2'>
          {CUSTOM_RIGHT_CLICK_CONTEXT_MENU_RANDOM_POST && (
            <div
              ...
              className='w-full px-2 h-10 flex justify-start items-center flex-nowrap cursor-pointer hover:bg-[#31433f] hover:text-white rounded-lg duration-200 transition-all'>
