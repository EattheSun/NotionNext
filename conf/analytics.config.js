 ...
 */
module.exports = {
  ANALYTICS_VERCEL: process.env.NEXT_PUBLIC_ANALYTICS_VERCEL || true, // Vercel Web Analytics；月昭录 V1 内部统计默认启用，Notion Config / Vercel 环境变量可覆盖
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    ...
    'codeva-SG1EJenDde', // 百度搜索资源平台站点验证；Vercel 环境变量 / Notion Config 可覆盖
